...
exports.MongoDeleteBookRepository = void 0;
const mongodb_1 = require("mongodb");
const mongo_1 = require("../../database/mongo");
class MongoDeleteBookRepository {
    deleteBook(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const book = yield mongo_1.MongoClient.db
                .collection("books")
                .findOne({ _id: new mongodb_1.ObjectId });
            //validacoes
            if (!book) {
...
exports.MongoDeleteBookRepository = MongoDeleteBookRepository;
